defmodule Purple.WeatherTest do
  ...
  #     assert {:ok, %WeatherSnapshot{} = weather_snapshot} =
  #              Weather.create_weather_snapshot(valid_attrs)

  #     assert weather_snapshot.humidity == 120.5
  #     assert weather_snapshot.pressure == 120.5
  #     assert weather_snapshot.temperature == 120.5
  #     assert weather_snapshot.timestamp == ~N[2023-05-20 20:47:46]
  #   end
  ...
  #     assert {:ok, %WeatherSnapshot{} = weather_snapshot} =
  #              Weather.update_weather_snapshot(weather_snapshot, update_attrs)
  ...
  #              Weather.update_weather_snapshot(weather_snapshot, @invalid_attrs)
  ...
  #       Weather.get_weather_snapshot!(weather_snapshot.id)
  #     end
  #   end
